...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="flex items-center justify-between px-2">
      {
        selectable && <div className="flex-1 text-sm text-muted-foreground">
          {table.getFilteredSelectedRowModel().rows.length} trên tổng{' '}
          {table.getFilteredRowModel().rows.length} được chọn.
        </div>
      }
      <div className="flex items-center space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2">
          <p className="text-sm font-medium">Dữ liệu mỗi trang</p>
          <Select
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            <span className="sr-only">Tới trang kế</span>
